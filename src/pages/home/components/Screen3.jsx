...
function Screen3() {
  return (
    <div className='p-[5%] space-y-5 bg-[#eee]'>
        ...
        <div className="flex justify-center items-center gap-5 flex-wrap text-white">
...
const Features = ({gradient,title,desc}) => <div className={`${gradient} p-3 h-48  w-56 shadow-lg rounded-xl hover:translate-y-5 duration-200 bg-white space-y-5`}>
